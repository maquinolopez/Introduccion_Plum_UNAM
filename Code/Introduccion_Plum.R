...
Sys.sleep(2)
for (i in 1:30){
  points(x= rnorm(1,50,10),y = 0,pch = 16,col = rgb(0,0,1,.5) )
  Sys.sleep(1)
}
...
### Installing previus version of rplum
install.packages('devtools')  # if you dont have devtools install

#To install the rplum version 0.1.4

devtools::install_version('rplum',version="0.1.4")
